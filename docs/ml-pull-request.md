...
* [Staging workspace registered model](https://reply-data-it-sandbox.cloud.databricks.com#mlflow/models/staging-my-mlops-project-model)
* [Prod workspace registered model](https://reply-data-it-sandbox.cloud.databricks.com#mlflow/models/prod-my-mlops-project-model)
